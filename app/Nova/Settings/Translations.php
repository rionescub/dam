...
return array_map(function ($setting) {
    ...
    ['reset_password_submit_button', 'Reset Password Submit Button', Text::class],
    ['reset_password_form_title', 'Reset Password Form Title', Text::class],
    ['new_password_field', 'Reset Password New Password Field', Text::class],
    ['confirm_password_field', 'Reset Password Confirm Password Field', Text::class],
    ['password_reset_success', 'Reset Password Success Message', Text::class],
    ['password_reset_failed', 'Reset Password Error Message', Text::class],
    ['terms_and_conditions_page_name', 'Terms and Conditions Page Name', Text::class],
    ...
    ['sponsors_name', 'Sponsors Translation', Text::class],
    ['partners_name', 'Partners Translation', Text::class],
    ['supporters_name', 'Supporters Translation', Text::class],
    ...
    ['rate_title', 'Rate Title', Text::class],
    ['rate_save_button', 'Rate Save Button', Text::class],
    ['rate_no_contest', 'Rate No Contest Message', Text::class],
    ['rate_creativity_score', 'Creativity Score', Text::class],
    ['rate_theme_score', 'Theme Score', Text::class],
    ['rate_aesthetic_score', 'Aesthetic Score', Text::class],
